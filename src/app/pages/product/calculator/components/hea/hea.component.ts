...
@Component({
  selector: 'claculator-hea',
  templateUrl: './hea.component.html',
  styleUrls: ['./hea.component.scss'],
})
export class HEAComponent implements OnInit {
  form!:FormGroup;
  ...
  loadData() {
    this.httpService.get('assets/data/HEA_DATA.json').subscribe((Data: any) => {
