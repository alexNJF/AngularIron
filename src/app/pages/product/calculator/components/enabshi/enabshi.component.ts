...
@Component({
  selector: 'claculator-enabshi',
  templateUrl: './enabshi.component.html',
  styleUrls: ['./enabshi.component.scss']
})
export class ENabshiComponent implements OnInit {
  form!: FormGroup;
  _components?: any
  ...
  loadData() {
    ...
    this.httpService.get('assets/data/E_NABSHI_DATA.json').subscribe((Data: any) => {
