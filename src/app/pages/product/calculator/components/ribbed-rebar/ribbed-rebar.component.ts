...
@Component({
  selector: 'claculator-ribbedRebar',
  templateUrl: './ribbed-rebar.component.html',
  styleUrls: ['./ribbed-rebar.component.scss']
})
export class RibbedRebarComponent implements OnInit {
  form !: FormGroup;
  result: number = 0;
  result1M: number = 0;
  constructor(
